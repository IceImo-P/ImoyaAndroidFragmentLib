...
/**
 * Log for ImoyaAndroidFragmentLib
 *
 * * Interfaces are compatible with [android.util.Log].
 * * If you will setup minimum output log level for ImoyaAndroidFragmentLib,
 *   set string resource named "imoya_android_fragment_log_level" and call [FragmentLog.init] on
 *   created application or activity.
 *
 * @author IceImo-P
 */
@Suppress("unused")
object FragmentLog : StaticLogTemplate(LogLevel.NONE) {
    /**
    ...
    fun init(context: Context) {
        super.init(context, R.string.imoya_android_fragment_log_level)
    }
